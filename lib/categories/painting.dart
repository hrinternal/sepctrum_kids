...
import 'package:spectrum_kids/categories/painter.dart';
...
class _ExamplePageState extends State<PaintingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_finished) {
      ...
      actions = <Widget>[
        new IconButton(
            icon: new Icon(Icons.undo, color: ColorBox.primaryColor,),
            tooltip: 'Undo',
            onPressed: () {
        ...
        new IconButton(
            icon: new Icon(Icons.delete, color: ColorBox.primaryColor,),
            tooltip: 'Clear',
            onPressed: _controller.clear),
        new IconButton(
            icon: new Icon(Icons.check, color: ColorBox.primaryColor),
            onPressed: () => _show(_controller.finish(), context)),
      ];
    }
    return new Scaffold(
      appBar: new AppBar(
          title: Text('DRAW', style: TextStyle(fontSize: 25, color:ColorBox.primaryColor),),
        ...
        new StatefulBuilder(
            builder: (BuildContext context, StateSetter setState) {
              return new RotatedBox(
                  ...
                  child: IconButton(
                      icon: new Icon(Icons.create, color: ColorBox.primaryColor,),
