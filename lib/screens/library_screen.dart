          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text('ENGLISH', style:TextStyle(fontSize: 30, fontWeight: FontWeight.w500, color: Color(0xffD9583B))),
              ),
              Expanded(
                flex: 2,
                child: ListView(
              ...
              Padding(
                padding: const EdgeInsets.only(left: 8.0),
                child: Text('MATHEMATICS', style:TextStyle(fontSize: 30, fontWeight: FontWeight.w500, color: Color(0xffD9583B))),
              ),
              Expanded(
                flex: 2,
                child: ListView(
